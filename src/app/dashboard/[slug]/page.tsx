            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <Badge
                    variant="outline"
                    className={getTopicColor(problemData.topic)}
                  >
                    {problemData.topic}
                  </Badge>
                  <Badge
            ...
            <Tabs defaultValue="problem" className="w-full">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {Array.isArray(problemData.examples)
                        ...
                        : JSON.parse(problemData.examples).map(
                  ...
                  <CardContent>
                    <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                      {Array.isArray(problemData.constraints)
                        ...
                        : JSON.parse(problemData.constraints).map(
              ...
              <TabsContent value="analytics" className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {problemData.analytics.attemptHistory.map(
                        (attempt, index) => (
                          <div
                            key={index}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {problemData.analytics.similarProblems.map(
                        (problem, index) => (
                          <div
                            key={index}
                            className="flex items-center justify-between p-3 bg-muted rounded-lg"
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span>
                      {problemData.analytics.topicProgress.current}/
                      {problemData.analytics.topicProgress.total}
                    </span>
                  </div>
                  <Progress
                    value={problemData.analytics.topicProgress.percentage}
                  />
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <Progress
                      value={
                        (problemData.analytics.difficultyProgress.medium
                          .solved /
                          problemData.analytics.difficultyProgress.medium
                            .total) *
                        100
